...
" NOTE: ~/dotfiles/tools/spacevim/autoload/ linked to ~/.SpaceVim.d/autoload/
...
function! myspacevim#before() abort
  source ~/.SpaceVim.d/autoload/plugins.vim     " load Vim plugins configs
...
function! myspacevim#after() abort
  ...
  source ~/.SpaceVim.d/autoload/editor.vim      " load Vim editor settings
  " source ~/.SpaceVim.d/autoload/plugins.vim     " load Vim plugins configs
  source ~/.SpaceVim.d/autoload/keymaps.vim     " load custom Vim keymaps
